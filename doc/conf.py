...
project = u'Autocall documentation'
project_short_name = u'autocall'
...
latex_documents = [
  ('contents', 'Autocall.tex', u'Autocall documentation',
   u'TEL4VN contributors', 'manual'),
]
